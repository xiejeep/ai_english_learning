...
class SimpleTTSService {
  ...
  Future<void> _fetchAndPlayAudio(String messageText, {String? appId}) async {
    ...
    try {
      print('🔄 [SimpleTTS] 开始重新获取音频: ${messageText.substring(0, messageText.length > 50 ? 50 : messageText.length)}...');
      print('🔍 [SimpleTTS] 使用appId: $appId');
      
      // 调用 getTTSAudio 重新获取音频，传递appId参数
      final audioFilePath = await _chatRemoteDataSource!.getTTSAudio(messageText, appId: appId);

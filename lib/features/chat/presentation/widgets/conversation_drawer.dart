    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (conversationListState.conversations.isEmpty) {
        ...
        ref
            ...
            .loadConversations(appId: chatState.appId);
      }
              ...
              Consumer(
                builder: (context, ref, child) {
                  ...
                  return userProfileAsync.when(
                    ...
                    data:
                        (profile) => Text(
                          '当前Token余额：${profile.tokenBalance}',
      ...
      child: ListTile(
        ...
        onTap: () async {
          final currentConversationId =
              ref.read(chatProvider).currentConversation?.id;
    ...
    showDialog(
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Text(
              '确定要删除对话「${conversation.displayName}」吗？\n\n此操作不可撤销，会永久删除该对话的所有消息记录。',
            ),
            actions: [
              TextButton(
                onPressed: () => Navigator.pop(context),
              ...
              TextButton(
                onPressed: () {
                  ...
                  ref
                      .read(conversationListProvider.notifier)
                      .deleteConversation(conversation.id, appId: appId);
                  Navigator.pop(context);

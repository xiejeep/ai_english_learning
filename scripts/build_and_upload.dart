...
Future<void> uploadToPgyer() async {
  ...
  print('📦 文件大小: ${(apkFile.lengthSync() / 1024 / 1024).toStringAsFixed(2)} MB');
...
Future<void> checkBuildStatus(String apiKey, String buildKey) async {
  ...
  while (attempts < maxAttempts) {
    ...
    final response = await http.get(
      Uri.parse('https://api.pgyer.com/apiv2/app/buildInfo?_api_key=$apiKey&buildKey=$buildKey'),
    );
    ...
    if (response.statusCode == 200) {
      ...
      if (data['code'] == 0) {
        ...
        print('🔗 下载链接: https://www.pgyer.com/${buildInfo['buildShortcutUrl']}');
        return;
